    ...
    <div className="min-h-screen bg-void flex items-center justify-center p-6">
      <div className="w-full max-w-md">
        ...
        <div className="card-elevated p-8">
          <h1 className="font-display text-2xl text-center mb-2">Welcome Back</h1>
          <p className="text-white/50 text-center mb-8">Sign in to access your dashboard</p>
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            <div className="flex items-center justify-between text-sm">
              ...
              <Link href="/forgot-password" className="text-gold hover:text-gold-bright transition-colors">
                Forgot password?
              </Link>
            </div>
